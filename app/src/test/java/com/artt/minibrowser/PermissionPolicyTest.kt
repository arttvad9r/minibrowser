...
class PermissionPolicyTest {
    @Test fun hardDenyCannotBeOverriddenButDefaultDenyCan() {
        ...
        assertEquals(deny, resolveContentPermissionValue(PermissionAction.DEFAULT_DENY, prompt))
        assertEquals(allow, resolveContentPermissionValue(PermissionAction.DEFAULT_DENY, allow))
        assertEquals(deny, resolveContentPermissionValue(PermissionAction.DEFAULT_DENY, deny))
    ...
    @Test fun mapsDefaultContentPermissionsToExistingBrowserPolicy() {
        ...
        assertEquals(PermissionAction.DEFAULT_DENY, contentPermissionAction(GeckoSession.PermissionDelegate.PERMISSION_AUTOPLAY_AUDIBLE))
        assertEquals(PermissionAction.DEFAULT_DENY, contentPermissionAction(GeckoSession.PermissionDelegate.PERMISSION_DESKTOP_NOTIFICATION))
        assertEquals(PermissionAction.DENY, contentPermissionAction(GeckoSession.PermissionDelegate.PERMISSION_TRACKING))
        assertEquals(PermissionAction.DEFAULT_DENY, contentPermissionAction(GeckoSession.PermissionDelegate.PERMISSION_LOCAL_DEVICE_ACCESS))
        assertEquals(PermissionAction.DEFAULT_DENY, contentPermissionAction(GeckoSession.PermissionDelegate.PERMISSION_LOCAL_NETWORK_ACCESS))
        assertEquals(PermissionAction.DEFAULT_DENY, contentPermissionAction(GeckoSession.PermissionDelegate.PERMISSION_XR))
        assertEquals(PermissionAction.DEFAULT_DENY, contentPermissionAction(GeckoSession.PermissionDelegate.PERMISSION_PERSISTENT_STORAGE))
